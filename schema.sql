...
-- 2. Regions Table (Province Master Data)
CREATE TABLE "Region" (
...
-- 3. Commodities Table (Master Data)
...
CREATE TABLE "Price" (
    "id" TEXT PRIMARY KEY,           -- Unique identifier (e.g., UUID or hashed composite)
    ...
    "createdAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    -- Prevent duplicate records for the same commodity, region, and date
    UNIQUE("commodityId", "regionId", "dateParam")
);
